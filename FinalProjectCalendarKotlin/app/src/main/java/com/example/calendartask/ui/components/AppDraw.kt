package com.example.calendartask.ui.components
...
import com.example.calendartask.ui.theme.CalendarTaskTheme
import com.example.calendartask.ui.theme.CalendarTaskThemeSettings
...
private fun LightDarkThemeItem() {
    Row(
        ...
        Switch(
            checked = CalendarTaskThemeSettings.isDarkThemeEnabled,
            onCheckedChange = { CalendarTaskThemeSettings.isDarkThemeEnabled = it },
            modifier = Modifier
...
fun AppDrawer(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        ScreenNavigationButton(
            ...
            onClick = {
                CalendarTaskRouter.navigateTo(Screen.Calendar)
                closeDrawerAction()
            }
        )
        ScreenNavigationButton(
            ...
            onClick = {
                CalendarTaskRouter.navigateTo(Screen.Trash)
                closeDrawerAction()
            }
        )
        LightDarkThemeItem()
