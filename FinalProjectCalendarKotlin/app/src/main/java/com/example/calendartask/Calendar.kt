...
import com.example.calendartask.domain.model.DaySelectedStatus
...
import com.example.calendartask.util.Circle
import com.example.calendartask.util.SemiRect
...
fun DayPreview() {
    CalendarTaskTheme {
        Calendar(DatesLocalDataSource().year2021, onDayClicked = { _, _ -> })
    }
}
